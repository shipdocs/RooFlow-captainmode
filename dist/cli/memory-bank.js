...
exports.setupMemoryBankCommands = setupMemoryBankCommands;
const MemoryBankManager_1 = require("../memory-bank/MemoryBankManager");
function setupMemoryBankCommands(program, roo) {
    ...
    memoryBankCommand
        ...
        .action(async () => {
        const memoryBankManager = new MemoryBankManager_1.MemoryBankManager(roo.getRootPath());
    ...
    memoryBankCommand
        ...
        .action(async (title, rationale, implementation) => {
        const memoryBankManager = new MemoryBankManager_1.MemoryBankManager(roo.getRootPath());
    ...
    memoryBankCommand
        ...
        .action(async (name, type, description) => {
        const memoryBankManager = new MemoryBankManager_1.MemoryBankManager(roo.getRootPath());
    ...
    memoryBankCommand
        ...
        .action(async (fromMode, toMode, reason) => {
        const memoryBankManager = new MemoryBankManager_1.MemoryBankManager(roo.getRootPath());
